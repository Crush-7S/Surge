...
const DEFAULT_OPTIONS = {
  ...
  fullContent: 'Support for Netflix _ Region ➟ #REGION_NAME_EN#',
  fullIcon: '',
  fullIconColor: '',
  fullStyle: 'good',
  onlyOriginalContent: 'Only supports self-made drama _ Region ➟ #REGION_NAME_EN#',
  onlyOriginalIcon: '',
  onlyOriginalIconColor: '',
  onlyOriginalStyle: 'info',
  notAvailableContent: 'Netflix is not supported.',
  notAvailableIcon: '',
  notAvailableIconColor: '',
  notAvailableStyle: 'alert',
  errorContent: 'Detection failed, please try again.',
  errorIcon: '',
  errorIconColor: '',
  errorStyle: 'error',
}
